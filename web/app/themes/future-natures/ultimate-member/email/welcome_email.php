...
<div style="padding: 30px 0;font-size: 24px;text-align: center;line-height: 40px"><span>Your account is now active! You can now visit the members' area of the Future Natures site, and join the forum on Discourse using the same login details.</span></div>
